...
public class UserGroupSpecification {
  ...
  public static Specification<UserGroup> filterBy(UserGroupListFiltersDto filters) {
  ...
  private static Specification<UserGroup> hasUserId(UUID userId) {
    return (root, query, cb) -> {
      if (userId != null) {
  ...
  private static Specification<UserGroup> hasRoleId(UUID roleId) {
    return (root, query, cb) -> {
      if (roleId != null) {
