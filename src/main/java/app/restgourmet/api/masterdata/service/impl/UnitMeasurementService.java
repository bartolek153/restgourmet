...
import app.restgourmet.api.masterdata.mappers.IUnitMeasurementMapper;
...
@Service
public class UnitMeasurementService implements IUnitMeasurementService {

  private final BaseUnitRepository baseUnitRepository;
  private final UnitMeasurementRepository unitMeasurementRepository;

  @Autowired
  private IUnitMeasurementMapper unitMeasurementMapper;

  public UnitMeasurementService(UnitMeasurementRepository unitMeasurementRepository,
