...
public class ProductCategoryController {
  ...
  @PostMapping
  public ResponseEntity<UUID> createCategory(@RequestBody @Valid CreateProdCategoryDto data) {
    UUID id = productCategoryService.create(data);
    return ResponseEntity.status(HttpStatus.CREATED).body(id);
  }

  @PutMapping("/{id}")
  public ResponseEntity<?> editCategory(@PathVariable UUID id, @Valid @RequestBody EditProdCategoryDto dto) {
