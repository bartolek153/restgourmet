...
// import
// app.restgourmet.api.usermanagement.repository.projections.UserListProjection;
...
// Optional<UserEntity> user = userRepository.findByNicknameOrEmail(nickname,
// null);
...
// Optional<UserEntity> user = userRepository.findByNicknameOrEmail(null,
// email);
