...
import { CurrencyCreateForm } from "./create";
  ...
  return (
    <>
      ...
      >
        <Form {...searchFormProps} layout="horizontal" onValuesChange={filterPageDelayed}>
          <Space wrap>
            <Form.Item label="Search" name="q">
              <Input placeholder="Code, description" prefix={<AiOutlineSearch />} allowClear />
            </Form.Item>
          </Space>
        </Form>
        ...
        >
          <Table.Column dataIndex="code" title={"Code"} sorter={true} />
      ...
      <CurrencyCreateForm modalProps={createModalProps} formProps={createFormProps} />
    </>
  );
};
